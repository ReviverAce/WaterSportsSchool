...
public class AddDeskaFrame extends JFrame {
	 ...
	 * @param rectangle 
	 */
	public AddDeskaFrame(int width, int height, int x1,int x2,int x3,int x4) {
	...
	private void initComponents(int width, int height, int x1,int x2,int x3,int x4) {
		...
		JLabel lblSystemZarzdzaniaSzko = new JLabel("Wprowadz dane dla nowej deski",SwingConstants.CENTER);
		...
		JLabel lblStawka = new JLabel("Wyporność:");
		...
		JLabel lblNewLabel_3 = new JLabel("Długość:");
		
		JLabel lblNewLabel_4 = new JLabel("Szerokość:");
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(textField_5, GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)
								.addComponent(textField, GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)
								...
								.addComponent(textField_4, GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)))
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(textField_6, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE))))
					.addContainerGap())
		);
		...
		btnZatwierdz.addActionListener((ActionListener) new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					flag = false;
					JOptionPane.showMessageDialog(null, "Wypornosc może zawierać tylko cyfry");
				}
				...
				try {
					...
					flag = false;
					JOptionPane.showMessageDialog(null, "Dlugość musi zawierać tylko cyfry");
				}
				
				try {
					if (Integer.parseInt(textField_6.getText()) < 0) {
						throw new Exception();
					}
				} catch (Exception ex) {
					flag = false;
					JOptionPane.showMessageDialog(null, "Szerokość musi zawierać tylko cyfry");
				}

				if (flag) {
					Deska.dodajSprzet(textField.getText(), Stan.WOLNY, Integer.parseInt(textField_1.getText()), textField_2.getText(), Integer.parseInt(textField_5.getText()), textField_4.getText(), Integer.parseInt(textField_3.getText()), Integer.parseInt(textField_6.getText()));
					JOptionPane.showMessageDialog(null, "Dodano Deske");
