...
public class AddWypozyczenieFrame extends JFrame {
	 ...
	 * @param rectangle 
	 */
	public AddWypozyczenieFrame(int width, int height, int x1,int x2,int x3,int x4) {
	...
	private void initComponents(int width, int height, int x1,int x2,int x3,int x4) {
		...
		JLabel lblSystemZarzdzaniaSzko = new JLabel("Wprowadz dane dla nowego wypożyczenia",SwingConstants.CENTER);
		...
		JLabel lblNewLabel = new JLabel("Data wypożyczenia:");
		
		JLabel lblNewLabel_1 = new JLabel("Klient:");
		
		JLabel lblTelefon = new JLabel("Sprzęt:");
		
		JLabel lblStawka = new JLabel("Na ile:");
		...
		comboBox.setModel(new DefaultComboBoxModel(TypWypozyczenie.values()));
