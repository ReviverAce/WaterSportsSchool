...
public class AddWiosloFrame extends JFrame {
	 ...
	 * @param rectangle 
	 */
	public AddWiosloFrame(int width, int height, int x1,int x2,int x3,int x4) {
	...
	private void initComponents(int width, int height, int x1,int x2,int x3,int x4) {
		...
		JLabel lblSystemZarzdzaniaSzko = new JLabel("Wprowadz dane dla nowego wiosła",SwingConstants.CENTER);
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(lblStawka, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
	...
	private void createEvents() {
		...
		btnZatwierdz.addActionListener((ActionListener) new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (flag) {
					Wioslo.dodajSprzet(textField.getText(), Stan.WOLNY, Integer.parseInt(textField_1.getText()), textField_2.getText(), Integer.parseInt(textField_3.getText()));
					JOptionPane.showMessageDialog(null, "Dodano wiosło");
