...
public class AddIndywidualnaFrame extends JFrame {
	 ...
	 * @param rectangle
	 */
	public AddIndywidualnaFrame(int width, int height, int x1, int x2, int x3, int x4) {
	...
	private void initComponents(int width, int height, int x1, int x2, int x3, int x4) {
		...
		setTitle("Dodaj lekcje indywidualną");
		...
		JLabel lblSystemZarzdzaniaSzko = new JLabel("Wprowadz dane dla nowej lekcji indywidualnej",
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
								...
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(textField_2, GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
										.addComponent(comboBox, 0, 381, Short.MAX_VALUE)))
